...
void setup() {
  ...
  digitalWrite(GFX_BL, HIGH);
   ...
   delay(10);
   gfx->fillRect(x, y, screenWidth / 2, screenHeight / 2, RED);
   gfx->fillRect((screenWidth / 2) + 1, y, screenWidth, (screenHeight / 2), BLUE);
   gfx->fillRect(x, (screenHeight / 2) + 1, screenWidth / 2, screenHeight, GREEN);
